            ...
            <div class="col-md-2 d-flex pb-2">
                <div class="card h-100 w-70">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="card-text flex-grow-1 text-sm pb-3">{{ $panjang->desc_singkat }}</p>
                        <a href="{{ route('detail', ['id' => $panjang->id]) }}" class="btn bg-red-700 font-bold text-white hover:bg-red-500 mt-auto">Lihat Detail</a>
                    </div>
                </div>
            </div>
            @endforeach
            ...
            <div class="col-md-2 d-flex pb-2">
                <div class="card h-100 w-70">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="card-text flex-grow-1 text-sm pb-3">{{ $lain->deskripsi_singkatt }}</p>
                        <a href="{{ route('detail', ['id' => $menu->id]) }}" class="btn bg-red-700 font-bold text-white hover:bg-red-500 mt-auto">Lihat Detail</a>
                    </div>
                </div>
            </div>
